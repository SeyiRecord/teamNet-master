    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><H2>{{ Auth::user()->userName }}</H2>Create Research Dashboard</div>

                <div class="panel-body">
                        {{ csrf_field() }}
                        {!! Form::open(['method' => 'POST', 'url' => '/researches/store', 'files' => true,]) !!}
                        <div class="form-group{{ $errors->has('topic') ? ' has-error' : '' }}">
                            <label for="topic" class="col-md-4 control-label">Topic</label>
                            <div class="col-md-6">
                                <input id="topic" type="topic" class="form-control" name="topic" value="{{ old('topic') }}" required autofocus>
                                @if ($errors->has('topic'))
                        ...
                        <div class="form-group{{ $errors->has('summary') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="4" cols="50" class="form-control" name="summary" value="{{ old('summary') }}" required autofocus> </textarea>
